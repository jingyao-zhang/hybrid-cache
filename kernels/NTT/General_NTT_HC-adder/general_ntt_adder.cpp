...
int main()
{
    ...
    printf("EBCC: %d\n", EBCC);
    printf("AddCC: %d\n", AddCC);
    printf("Total instruction: %d\n", ReadCC + WriteCC + LeftShiftInst + RightShiftInst + ActCC + OrCC + AndCC + XorCC + NotCC + EBCC + AddCC);
    printf("Total cycle: %d\n", ReadCC + WriteCC + LeftShift + RightShift + ActCC + OrCC + AndCC + XorCC + NotCC + EBCC + AddCC);
