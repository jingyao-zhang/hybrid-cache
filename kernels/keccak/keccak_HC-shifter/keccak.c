...
static void KeccakF1600_StatePermute(uint64_t *state) {
    ...
    for (round = 0; round < NROUNDS; round += 2) {
        ...
        Du = BCo ^ ROL(BCa, 1);
        XorCC_counter(5);
        LeftShift_counter(5, 1); // LeftShift_counter(5, 1);
        ...
        BCe = ROL(Age, 44);
        XorCC_counter(2);
        LeftShift_counter(1, 1); // LeftShift_counter(1, 44);
        ...
        BCi = ROL(Aki, 43);
        XorCC_counter(1);
        LeftShift_counter(1, 1); // LeftShift_counter(1, 43);
        ...
        BCo = ROL(Amo, 21);
        XorCC_counter(1);
        LeftShift_counter(1, 1); // LeftShift_counter(1, 21);
        ...
        BCu = ROL(Asu, 14);
        XorCC_counter(1);
        LeftShift_counter(1, 1); // LeftShift_counter(1, 14);
        ...
        BCa = ROL(Abo, 28);
        XorCC_counter(1);
        LeftShift_counter(1, 1); // LeftShift_counter(1, 28);
        ...
        BCe = ROL(Agu, 20);
        XorCC_counter(1);
        LeftShift_counter(1, 1); // LeftShift_counter(1, 20);
        ...
        BCi = ROL(Aka, 3);
        XorCC_counter(1);
        LeftShift_counter(1, 1); // LeftShift_counter(1, 3);
        ...
        BCo = ROL(Ame, 45);
        XorCC_counter(1);
        LeftShift_counter(1, 1); // LeftShift_counter(1, 45);
        ...
        BCu = ROL(Asi, 61);
        XorCC_counter(1);
        LeftShift_counter(1, 1); // LeftShift_counter(1, 61);
        ...
        BCa = ROL(Abe, 1);
        XorCC_counter(1);
        LeftShift_counter(1, 1); // LeftShift_counter(1, 1);
        ...
        BCe = ROL(Agi, 6);
        XorCC_counter(1);
        LeftShift_counter(1, 1); // LeftShift_counter(1, 6);
        ...
        BCi = ROL(Ako, 25);
        XorCC_counter(1);
        LeftShift_counter(1, 1); // LeftShift_counter(1, 25);
        ...
        BCo = ROL(Amu, 8);
        XorCC_counter(1);
        LeftShift_counter(1, 1); // LeftShift_counter(1, 8);
        ...
        BCu = ROL(Asa, 18);
        XorCC_counter(1);
        LeftShift_counter(1, 1); // LeftShift_counter(1, 18);
        ...
        BCa = ROL(Abu, 27);
        XorCC_counter(1);
        LeftShift_counter(1, 1); // LeftShift_counter(1, 27);
        ...
        BCe = ROL(Aga, 36);
        XorCC_counter(1);
        LeftShift_counter(1, 1); // LeftShift_counter(1, 36);
        ...
        BCi = ROL(Ake, 10);
        XorCC_counter(1);
        LeftShift_counter(1, 1); // LeftShift_counter(1, 10);
        ...
        BCo = ROL(Ami, 15);
        XorCC_counter(1);
        LeftShift_counter(1, 1); // LeftShift_counter(1, 15);
        ...
        BCu = ROL(Aso, 56);
        XorCC_counter(1);
        LeftShift_counter(1, 1); // LeftShift_counter(1, 56);
        ...
        BCa = ROL(Abi, 62);
        XorCC_counter(1);
        LeftShift_counter(1, 1); // LeftShift_counter(1, 62);
        ...
        BCe = ROL(Ago, 55);
        XorCC_counter(1);
        LeftShift_counter(1, 1); // LeftShift_counter(1, 55);
        ...
        BCi = ROL(Aku, 39);
        XorCC_counter(1);
        LeftShift_counter(1, 1); // LeftShift_counter(1, 39);
        ...
        BCo = ROL(Ama, 41);
        XorCC_counter(1);
        LeftShift_counter(1, 1); // LeftShift_counter(1, 41);
        ...
        BCu = ROL(Ase, 2);
        XorCC_counter(1);
        LeftShift_counter(1, 1); // LeftShift_counter(1, 2);
...
void shake128(uint8_t *output, size_t outlen,
    ...
    shake128_absorb(&s, input, inlen); // No cost on the absorb while the data pre-processing is done by the CPU. The CPU must align the message required to be hashed in 1600-bit fashion. There is no possibility to do it in Crypto-Cache because the data alignment need the information about the end of the message which the Crypto-Cache cannot know.
